...
$urlm[]="http://www.goalserve.com/getfeed/7633785d0416465f9f8b944b92c30cf2/getodds/soccer?cat=cyprus";
$urlm[]="http://www.goalserve.com/getfeed/7633785d0416465f9f8b944b92c30cf2/getodds/soccer?cat=czechia";
$urlm[]="http://www.goalserve.com/getfeed/7633785d0416465f9f8b944b92c30cf2/getodds/soccer?cat=denmark";
$urlm[]="http://www.goalserve.com/getfeed/7633785d0416465f9f8b944b92c30cf2/getodds/soccer?cat=egypt";
$urlm[]="http://www.goalserve.com/getfeed/7633785d0416465f9f8b944b92c30cf2/getodds/soccer?cat=england";

for($i=0;$i<count($urlm);$i++){
$content =  file_get_contents($urlm[$i]);
  ...
  if(!empty ($content)){
	...
	//chmod('xml', 0777);
	$content = str_replace("\r\n","",$content);
    file_put_contents(dirname(__FILE__) . '/match4-'.$i.'.xml', $content);
...
for($i=0;$i<count($urlm);$i++){
echo $urlm[$i];
$xml = json_decode(json_encode(simplexml_load_file('match4-'.$i.'.xml')), true);
// Get League
