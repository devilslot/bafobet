...
if($_GET['types']=='rank'){
        ...
        *
        FROM
        members_score
			where months='".(date('m')-1)."' AND years='".date('Y')."'
        ORDER BY
        rank
        DESC
        LIMIT 3
...
<div style="width:700px; float:left;">
  ...
  <div style="width:290px; float:right;">
  	<button type="button" style="margin:0px auto 5px auto;" class="btn btn-warning btn-block dep-button" onclick="deptm()"><span class="glyphicon glyphicon-plus-sign"></span> ฝากบัตรเงินสดเข้าถุงเงิน</button>
  	<br />
...
<table width="850" border="0" align="center" style="margin-bottom:15px;">
  ...
  <tr>
    ...
    <td><div class="gtb"></div>
    	<div class="buttonbet">
        <a href="#" target="_blank" style="margin:14px 20px 0px auto; color:#FFFFFF;" class="btn btn-success">ทางเข้าเล่น</a>
        <button type="button" style="margin:14px 20px 0px auto;" class="btn btn-primary" onclick="newusergames('FIFA55')" <?php echo $dcb;?>>เปิดไอดีเกมส์</button>
        <button type="button" style="margin:14px 20px 0px auto;" class="btn btn-info" onclick="tranmoney('FIFA55')" <?php echo $dca;?>>โยกย้ายเงิน</button>
        <button type="button" style="margin:14px 20px 0px auto;" class="btn btn-danger" onclick="wimoney('FIFA55')" <?php echo $dca;?>>ถอนเงิน</button></div></td>
  </tr>
  <tr>
    <td height="70" width="200" align="center">
    	<div class="buttonbet-pv">
    ...
    <td><div class="gtb"></div>
    	<div class="buttonbet">
        <a href="#" target="_blank" style="margin:14px 20px 0px auto; color:#FFFFFF;" class="btn btn-success">ทางเข้าเล่น</a>
        <button type="button" style="margin:14px 20px 0px auto;" class="btn btn-primary" onclick="newusergames('TBSBET')" <?php echo $dcb;?>>เปิดไอดีเกมส์</button>
        <button type="button" style="margin:14px 20px 0px auto;" class="btn btn-info" onclick="tranmoney('TBSBET')" <?php echo $dca;?>>โยกย้ายเงิน</button>
        <button type="button" style="margin:14px 20px 0px auto;" class="btn btn-danger" onclick="wimoney('TBSBET')" <?php echo $dca;?>>ถอนเงิน</button></div></td>
  </tr>
</table>
