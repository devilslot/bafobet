    ...
    <table width="1000" border="0" align="center" cellspacing="1" bgcolor="#202020" style="margin-top:5px;">
      ...
      <tr>
        ...
        <table width="990" border="0" align="center" cellspacing="1" bgcolor="#202020" style="margin-top:5px;">
            <tr>
              <td height="42" colspan="9" background="bg-menu1.jpg" bgcolor="#004000">
                ...
                <td width="100%" bgcolor="#000000" colspan="6" valign="top">
                  <div class="scroll">
                    ...
                    <?php
                      ...
                      ?>
                    <tr>
                        <td height="40" colspan="9" align="right" style="color:#FFF;">สรุปผลทั้งเดือนได้ <?=$sumpoint?> Point | <?=($sumrank*2)?> Rank</td>
                    </tr>
                      <tr>
       ...
       // echo $sql;
          ...
          while($rowm=mysql_fetch_assoc($querym)){
			...
			*/
			...
			?>
                      ...
                      $sql="
                      SELECT
                      md.*,pg.bet,pg.bet,pg.hdc,pg.point,pg.winloss,pg.status,pg.gametype,pg.date_create
                      FROM
        ...
        //echo $sql;
                      ...
                      while($row=mysql_fetch_assoc($query)){
                        ...
                        ?>
                        <tr>
                         <td height="35" bgcolor="<?php echo $bg;?>"><div align="center"><span class="style18"><?php echo date('d/m/Y H:s',$n_time);?></span></div></td>
                          ...
                          <td bgcolor="<?php echo $bg;?>"><div align="center" class="style25"><font color="#ffffff"><?php if(trim($row['gametype'])=='point'){ echo $row['point']; }else{ echo trim($row['gametype']); }; ?></font></div></td>
