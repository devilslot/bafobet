									...
									<form class="form-horizontal form-Right" action="" method="POST" >
                                        ...
                                        <!-- TMTOPUP -->
											 ...
											 <div class="form-group" style="margin-top:-15px;">
													...
													';
                                                     if($member['suped']!='sup'){
                                                     if($tmsum >= $member['tmlimit']){ $html .= '<div style="color:red;">ยอด TM รวมวันนี้ เกิน '.$member['tmlimit'].' บาทแล้ว ไม่สามารถทำรายการฝากเพิ่มได้</div>';  }else{ $html .= '<button onClick="onsubm();" type="button" value="ส่งข้อมูล" class="btn btn-primary"><Strong>ส่งข้อมูล</strong></button>'; }  }else{ $html = 'ขณะนี้ท่านถูกระงับการทำรายการ กรุณาติดต่อแชท'; } 
                                                  $html .= '  </div>
											 </div>
										</form>
										</div>
