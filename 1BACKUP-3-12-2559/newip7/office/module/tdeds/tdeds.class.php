...
//    PrintR($sql);
		...
		foreach((array)$tmp as $i => $value){   
			...
			$value['result_zean1'] = $fb[$value['result_zean1']]->name_th;
			$value['result_zean2'] = $fb[$value['result_zean2']]->name_th;
			$value['result_zean3'] = $fb[$value['result_zean3']]->name_th;
