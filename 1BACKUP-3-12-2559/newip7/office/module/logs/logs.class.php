...
function ModeDisplay($input){
  switch($input){
    case 'ADD' : $result = '<label class="label label-success">'.$input.'</label>'; break;
    case 'EDIT' : $result = '<label class="label label-info">'.$input.'</label>'; break;
    case 'DEL' : $result = '<label class="label label-danger">'.$input.'</label>'; break;
    case 'LOGIN' : $result = '<label class="label label-orange">'.$input.'</label>'; break;
    case 'LOGOUT' : $result = '<label class="label label-magenta">'.$input.'</label>'; break;
    default : $result = '<label class="label label-default">'.$input.'</label>'; break;
  }
  return $result;
}
