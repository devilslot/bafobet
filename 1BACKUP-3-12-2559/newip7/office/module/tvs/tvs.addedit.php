      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-horizontal" role="form">
            <?php
            $app->PushText('ชื่อช่อง', 'name_th', 'mydata empty');
        ...
        <div class="col-md-6">
          <div class="form-horizontal" role="form">
            <?php
            $app->PushTextArea('URL RTMP', 'url', 'mydata empty');
            ?>  
          ...
          <div class="form-horizontal" role="form">
            <form name="frmUpload" id="frmUpload" method="post" action="<?php echo "module/$mod/$mod.upload.php";?>" enctype="multipart/form-data" target="uploadtarget" style="margin:0;" onsubmit="return me.UploadPic.Submit();">
              <div id="dvfilepic" class="form-group">
                <label id="lblfilepic" for="filepic" class="col-sm-4 control-label" style="white-space:nowrap">ไฟล์ภาพ (330 x 330):</label>
                <div class="col-sm-8">
