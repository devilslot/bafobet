...
?>
      <table width="780" border="0" align="center" cellspacing="1" bgcolor="#202020" style="margin-top:5px;">
        <tr>
          <td height="42" colspan="10" background="bg-menu1.jpg" bgcolor="#004000"><div align="center" class="style5">
...
?>
      <table width="780" border="0" align="center" cellspacing="1" bgcolor="#202020" style="margin-top:5px;">
        <tr>
          <td height="42" colspan="9" background="bg-menu1.jpg" bgcolor="#004000"><div align="center" class="style5">
            <div align="left">&nbsp;&nbsp;<span class="style24">ผลบอลสด</span><span class="style70"> ประจำวันที่ <?php  echo thai_date_fullmonth(strtotime("+1 day", strtotime($date)));?></span></div>
          </div></td>
        </tr>
        <tr>
          <td width="7%" height="40" bgcolor="#000000"><div align="center" class="style27"><span class="style28">เวลา</span></div></td>
		...
		$loopp++;
          ...
          <tr bgcolor="<?=$bgb?>">
			...
			<div align="center"><span class="style18">
				...
				if($row['Status']=='-1'){ echo $statustime; }
				if($row['Status']=='Und'){ echo 'Und.'; }
				?>
