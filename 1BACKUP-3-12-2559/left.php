...
$cachetime =160;  // ระยะเวลา 100 วินาที 
...
?>    
	<div style="margin-top:6px;">
     ...
     <table width="100%" border="0" cellspacing="0" bgcolor="#252525">
          ...
          <td height="38" colspan="2" background="images/bg-menu1.jpg" class="style54"><table width="100%" border="0">
            <tr>
              <td width="88%"><div align="center" class="style55">
                <div align="center" style="wi"><span class="style24">สรุปรางวัล Point ประจำเดือน พฤศจิกายน</span></div>
              </div></td>
              <td width="12%"></td>
            </tr>
          </table></td>
          ...
          <tr>
            ...
            <div class="style57" style="min-height:30px; padding:5px; border:solid #999999; border-width:1px 0 0 0;">
              <table width="100%" border="0">
                <tr>
                  <?php  if ($rows['photo']!='') { ?>
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=memberpic/<?php echo $rows['photo']; ?>&w=20&q=50" style="width:20px;" width="20" /></div></td>
                  <?php }else{ ?>
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=pro-pic.jpg&w=20&q=50" width="20" style="width:20px;" /></div></td>
                  <?php } ?>
	  ...
	  <table width="100%" border="0" cellspacing="0" bgcolor="#252525">
        <tr>
          <td height="38" colspan="2" background="images/bg-menu1.jpg" class="style54"><table width="100%" border="0">
            <tr>
              <td width="88%"><div align="center" class="style55">
                <div align="center" style="wi"><span class="style24">สรุปรางวัล Rank ประจำเดือน พฤศจิกายน</span></div>
              </div></td>
              <td width="12%"></td>
            </tr>
          </table></td>
            ...
            <div class="style57" style="min-height:30px; padding:5px; border:solid #999999; border-width:1px 0 0 0;">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=memberpic/<?php echo $rows['photo']; ?>&w=20&q=50" style="width:20px;" width="20" /></div></td>
                  <?php }else{ ?>
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=pro-pic.jpg&w=20&q=50" style="width:20px;" width="20" /></div></td>
                  <?php } ?>
                  <td width="57%" style="color:#ffffff;"><a href="viewmemberplay.php?refID=<?=$rows['memberID']?>"><?php echo $rows['username'];?></a> 
      ...
      AND date_create like '".date('Y')."-".date('m')."%'
      GROUP BY
      memberID
      ORDER BY
      total
            ...
            <td colspan="2" class="style54"><div class="style57" style="height:30px; padding:5px; border:solid #999999; border-width:1px 0 0 0;">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=memberpic/<?php echo $row_photo['photo'];?>&w=20&q=50" style="width:20px;" width="20" /></div></td>
                  <?php }else{ ?>
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=pro-pic.jpg&w=20&q=50" style="width:20px;" width="20" /></div></td>
                  <?php } ?>
    ...
    <!--  <table width="100%" border="0" cellspacing="0" bgcolor="#252525">
        ...
        <tr>
          <td colspan="2" class="style54"><div class="style57" style="height:30px; padding:5px; border:solid 1px #999999;">
            <table width="100%" border="0">
              <tr>
                <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999;"><img src="thumb.php?src=pro-pic.jpg&w=20&q=50" width="20" /></div></td>
