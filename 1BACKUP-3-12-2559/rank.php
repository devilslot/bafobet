          ...
          <tr bgcolor="<?=$bgb?>">
            ...
            <td><?php  if (file_exists("memberpic/".$user.'.jpg')) { ?>
                 <div style="width:50px; height:50px; border:solid 1px #999999; overflow:hidden;"><img src="memberpic/<?php echo $user;?>.jpg" width="50" /></div>
                  ...
                  <?php } ?></td>
            <td><div align="center"><span class="style67 style18"><strong><span class="style67"><a style="color:#FFCC33;" href="viewmemberplay.php?refID=<?php echo $row['memberID'];?>&T=R"><?php echo $user;?></a> </span></strong></span></div></td>
