...
<body>
  ...
  <form id="frmLogin" name="frmLogin" method="post" action="<?php echo $url?>"  autocomplete="off">
    <div class="login-container animated fadeInDown">
        <div class="loginbox">
            <div class="loginbox-social padding-top-20 padding-left-40 padding-right-40">
                <img src="<?php echo URL; ?>/logo.png" class="img-responsive" />
            </div>
        ...
        <div class=" text-align-center padding-top-20" style="color:#ffffff;">
          Copyright &copy;<?php echo date('Y');?> - www.bafobet.com
      </div>
  </div>
</form>
...
<script src="<?php echo URL; ?>/office/login.script.js" charset="utf-8"></script>
