...
function GroupDisplay($g){
  switch($g){
    case 'CONTENT' : $result = '<span class="label label-success">CONTENT</label>'; break;
    case 'DEFINE' : $result = '<span class="label label-warning">DEFINE</label>'; break;
    case 'ALERT' : $result = '<span class="label label-danger">ALERT</label>'; break;
  }
...
//    PrintR($sql);
    ...
    foreach((array)$tmp as $i => $value){   
      $value['groups'] = GroupDisplay($value['groups']);
