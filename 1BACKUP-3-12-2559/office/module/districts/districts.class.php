  ...
  public function View(){
    ...
    for($i=$beginpage; $i<=$endpage; $i++){
      $runpage[] = $i;
		...
		$sql="
      SELECT 
        tb.*, ge.name_th AS geo_code, pv.name_th AS province_code, ap.name_th AS amphur_code
      FROM 
        $table tb, geographies ge, provinces pv, amphurs ap
      WHERE 
        $where 
        tb.amphur_code = ap.code AND
