...
/*================================================*\
  ...
  me.ViewHeader=function(){
  	me.ViewSetHeader([
      {display:'วันที่', name:'date_match',width:'100',cls:'dpk', align:"center",style:"danger"},
      {display:'ลีก', name:'League', align:"center",width:'180'},
      {display:'ทีมเจ้าบ้าน', name:'HomeTeam', align:"center"},
      {display:'ทีมเยือน', name:'AwayTeam', align:"center"},
      {display:'ทีมต่อ', name:'ratio', align:"center"},
      {display:'ราคา', name:'hdc', align:"center"},
      {display:'ทรรศนะ', name:'tded', align:"center"},
      ]);
  };
  ...
  me.ViewOpenHeader=function(){
      ...
      {display:'ลีก', name:'zean1'},
      {display:'ทีมเจ้าบ้าน', name:'HomeTeam'},
      {display:'ทีมเยือน', name:'AwayTeam'},
      {display:'ราคา', name:'hdc'},
      {display:'ทรรศนะ', name:'tded'},
      {display:'ช่องถ่ายทอด', name:'channel'},
...
me.SaveTded=function(code){
  ...
  $.ajax({
    url:me.url+'?mode=SaveTded&mod='+me.mod,
    type:'POST',
    dataType:'json',
    cache:false,
    data:myData,
...
me.SaveRate=function(code){
  ...
  $.ajax({
    url:me.url+'?mode=SaveRate&mod='+me.mod,
    type:'POST',
    dataType:'json',
    cache:false,
    data:myData,
