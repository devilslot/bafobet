...
//      $result['row'][$i]['item'][]=$value[''];
      ...
      $result['row'][$i]['collap'] = '
        <div class="row">
        <div class="col-md-6">
        <div class="form-title"><i class="glyphicon glyphicon-plane sky"></i> OUTBOUND Route</div>
        <div class="form-horizontal" role="form">
          ...
          <tbody>
            <tr>
            <td align="center" style="background-color:#ffffff;">direct_out_orgin</td>
            <td align="center" style="background-color:#ffffff;">direct_out_destination</td>
            </tr>
          </tbody>
          </table>
        </div>
        ...
        <div class="col-md-6">
        <div class="form-title"><i class="glyphicon glyphicon-plane red"></i> INBOUND Route</div>
        <div class="form-horizontal" role="form">
          <table class="table table-hover table-striped table-bordered table-condensed">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
            <td align="center" style="background-color:#ffffff;">direct_in_orgin</td>
            <td align="center" style="background-color:#ffffff;">direct_in_destination</td>
            </tr>
          </tbody>
          </table>
        </div>
