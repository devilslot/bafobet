    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
      <div class="widget flat radius-bordered">
        <div class="widget-header bordered-bottom bordered-themeprimary">
          ...
          <!-- <img src="http://www.369zean.com/live.gif"/>  <a href="http://www.369zean.com/index2.php" target="_blank">ดูข้อมูล feed</a> -->
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
      <div class="widget flat radius-bordered no-margin-bottom">
        <div class="widget-header bordered-bottom bordered-themeprimary">
          <span id="add_title" class="widget-caption"><i class="fa fa-plus-circle warning"></i> </span>
