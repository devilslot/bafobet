...
ob_start();
?>
    <div style="width:1020px; float:right; min-height:700px; ">
      <table width="1000" border="0" align="center" cellspacing="1" bgcolor="#202020" style="margin-top:5px;">
        <tr>
          <td height="42" background="images/bg-menu1.jpg" bgcolor="#004000"><div align="center" class="style5">
            <div align="left">&nbsp;&nbsp;<span class="style24">สรุป</span>การทายผล วันนี้</div>
          </div></td>
        </tr>
        <tr>
          ...
          while($rowm=mysql_fetch_assoc($querym)){
            ...
            <table width="1000" border="0" align="center" cellspacing="1" bgcolor="<?php echo $bgb; ?>" style="margin-top:5px;">
              <tr>
                <td width="150" rowspan="6" valign="top"  bgcolor="<?php echo $bgb; ?>"><div class="style54" style="width:140px; max-height:140px; margin:10px auto; border:solid 3px #CCCCCC; overflow:hidden;">
                  ...
                  <div style="width:140px; height:140px; border:solid 1px #999999; overflow:hidden; margin:0 auto;"><img src="memberpic/<?php echo $user;?>.jpg" width="140" /></div>
                  <?php }else{ ?>
                  <div style="width:140px; height:140px; border:solid 1px #999999; overflow:hidden; margin:0 auto;"><img src="pro-pic.jpg" width="140" /></div>
                  <?php } ?>
                </div>
                ...
                <div class="style54" style="width:140px; height:40px; line-height:40px; background: #222222; font-size:16px; margin:0 auto 10px auto;">
                  <div align="center"><strong><a href="viewmemberplay.php?refID=<?=$rowm['memberID']?>"><?php echo $user;?></a></strong></div>
                </div></td>
            ...
            <div align="left">&nbsp;&nbsp;<span class="style24">สรุป</span>การทายผล</div>
                        ...
                        <tr>
                          ...
                          <td  width="15%" bgcolor="#000000"><div align="center" class="style27"><span class="style28">ลีก</span></div></td>
                        ...
                        <?php
                        /* AND
                        pg.date_create LIKE '".date('Y-m-d')."%'*/
                        $sql="
                        SELECT
                        md.*,pg.*
                        FROM
                       ...
                       AND  UNIX_TIMESTAMP(pg.date_create) >= '".$datestart."'
