...
$file='week.html'; // ชื่อไฟล์เว็บ
$cachefile=$cachedir.'/'.$file;
$cachetime =21600;  // ระยะเวลา 100 วินาที 
    ...
    <table width="780" border="0" align="center" cellspacing="1" bgcolor="#202020" style="margin-top:5px;">
      <tr>
        <td height="42" colspan="8" background="images/bg-menu1.jpg" bgcolor="#004000"><div align="center" class="style5">
          <div align="left">&nbsp;&nbsp;<span class="style24">อันดับเซียนประจำสัปดาห์ (รวม Rank และ Point) 50 อันดับ</span></div>
        </div></td>
      </tr>
      <tr>
        ...
        <td width="15%" bgcolor="#000000"><div align="center" class="style27"><span class="style28">ได้/เสีย รวม</span></div></td>
      </tr>
      <?php
      $sql="
      SELECT
        ...
        <tr bgcolor="<?=$bgb?>">
          ...
          <td ><span class="style18"></span>
            <div class="style20" style="width:80%; margin:auto; padding:5px;  border:solid 1px #FFFF00 ">
              <div align="center" class="style25"><?php echo number_format($row['total']);?></div>
            </div></td>
          </tr>
          <?php 
        } 
