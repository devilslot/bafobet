<div style="margin-top:6px;">
	<?php
	$monthainame[01]='มกราคม';
	$monthainame[02]='กุมภาพันธ์';
	$monthainame[03]='มีนาคม';
	$monthainame[04]='เมษายน';
	$monthainame[05]='พฤษภาคม';
	$monthainame[06]='มิถุนายน';
	$monthainame[07]='กรกฎาคม';
	$monthainame[08]='สิงหาคม';
	$monthainame[09]='กันยายน';
	$monthainame[10]='ตุลาคม';
	$monthainame[11]='พฤศจิกายน';
	$monthainame[12]='ธันวาคม';
	...
	if(date('d')<='7'){ 
		if((date('d')=='01' and date('H')>'12') or date('d')!='01'){
	...
	?>
     <table width="100%" border="0" cellspacing="0" bgcolor="#252525">
          ...
          <td height="38" colspan="2" background="images/bg-menu1.jpg" class="style54"><table width="100%" border="0">
            <tr>
              <td width="88%"><div align="center" class="style55">
                <div align="center" style="wi"><span class="style24">สรุปรางวัล Point ประจำเดือน <?php echo $monthainame[$date_monb]; ?></span></div>
              </div></td>
              <td width="12%"></td>
            </tr>
          </table></td>
      ...
      //echo $sqls;
        ...
        while($rows=mysql_fetch_assoc($querys)){
		  ...
		  $query_photo=mysql_query("SELECT username,photo FROM members WHERE code = '".$rows['memberID']."' ;",$conn);
            ...
            <div class="style57" style="min-height:30px; padding:5px; border:solid #999999; border-width:1px 0 0 0;">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=memberpic/<?php echo $row_photo['photo']; ?>&w=20&q=100" style="width:20px;" width="20" /></div></td>
                  <?php }else{ ?>
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=images/pro-pic.jpg&w=20&q=100" width="20" style="width:20px;" /></div></td>
                  <?php } ?>
                  <td width="57%" style="color:#ffffff;"><a href="viewmemberplay.php?refID=<?=$rows['memberID']?>"><?php echo $rows['username'];?></a> 
				  <?php if($rows['getbonusp']=='0' and $rows['memberID']==$_SESSION[MEMBER]['DATA']['code'] ){ ?>
                  <a href="playbet.php?types=point&mbonus=true" class="btn btn-success btn-xs" style="color:#FFFFFF;">รับโบนัส</a>
                  <?php
				  }
                  
				 ?></td>
                  <td width="30%" style="color:#00FF00;"><div align="center"><?php echo $rows['point'];?>  
	  ...
	  <table width="100%" border="0" cellspacing="0" bgcolor="#252525">
        <tr>
          <td height="38" colspan="2" background="images/bg-menu1.jpg" class="style54"><table width="100%" border="0">
            <tr>
              <td width="88%"><div align="center" class="style55">
                <div align="center" style="wi"><span class="style24">สรุปรางวัล Rank ประจำเดือน <?php echo $monthainame[$date_monb]; ?></span></div>
              </div></td>
              <td width="12%"></td>
            </tr>
          </table></td>
            ...
            <div class="style57" style="min-height:30px; padding:5px; border:solid #999999; border-width:1px 0 0 0;">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=memberpic/<?php echo $row_photo['photo']; ?>&w=20&q=100" style="width:20px;" width="20" /></div></td>
                  <?php }else{ ?>
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=images/pro-pic.jpg&w=20&q=100" style="width:20px;" width="20" /></div></td>
                  <?php } ?>
                  <td width="57%" style="color:#ffffff;"><a href="viewmemberplay.php?refID=<?=$rows['memberID']?>"><?php echo $rows['username'];?></a> 
				  <?php if($rows['getbonusr']=='0' and $rows['memberID']==$_SESSION[MEMBER]['DATA']['code'] ){ ?>
                  <a href="playbet.php?types=rank&mbonus=true" class="btn btn-success btn-xs" style="color:#FFFFFF;">รับโบนัส</a>
                  <?php
				  }
                  
				 ?></td>
                  <td width="30%" style="color:#00FF00;"><div align="center"><?php echo $rows['rank'];?>  
     ...
     <?php } } ?>
      ...
      <table width="100%" border="0" cellspacing="0" bgcolor="#252525">
        ...
        $sqls="
        SELECT
        playgame.memberID,members.username,members.photo
        FROM
        playgame
		JOIN members
          ...
          <tr>
            ...
            <div class="style57" style="min-height:30px; padding:5px; border:solid #999999; border-width:1px 0 0 0;">
              <table width="100%" border="0">
                <tr>
                  <?php  if ($rows['photo']!='') { ?>
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=memberpic/<?php echo $rows['photo']; ?>&w=20&q=100" style="width:20px;" width="20" /></div></td>
                  <?php }else{ ?>
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=images/pro-pic.jpg&w=20&q=100" style="width:20px;" width="20" /></div></td>
                  <?php } ?>
                  <td width="57%" style="color:#ffffff;"><a href="viewmemberplay.php?refID=<?=$rows['memberID']?>"><?php echo $rows['username'];?></a> 
...
$cachetime =240;  // ระยะเวลา 100 วินาที 
...
?>    
        ...
        *
        FROM
        members_score
		where months='".$date_mon."' AND years='".$date_year."'
        ORDER BY
        rank
        DESC
        LIMIT 10
      ...
      AND date_create like '".$date_year."-".$date_mon."%'
      GROUP BY
      memberID
      ORDER BY
      total
            ...
            <td colspan="2" class="style54"><div class="style57" style="height:30px; padding:5px; border:solid #999999; border-width:1px 0 0 0;">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=images/pro-pic.jpg&w=20&q=100" style="width:20px;" width="20" /></div></td>
                  <?php } ?>
                  <td width="57%" style="color:#ffffff;"><a href="viewmemberplay.php?refID=<?=$rows['memberID']?>"><?php echo $row_photo['username'];?></a></td>
	  ...
	  $sqld="
		...
		$query_photo=mysql_query("SELECT username,photo FROM members WHERE code = '".$memberid[$x_value]."' ;",$conn);
        $row_photo=mysql_fetch_assoc($query_photo);
            ...
            <td colspan="2" class="style54"><div class="style57" style="height:30px; padding:5px; border:solid #999999; border-width:1px 0 0 0;">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999; overflow:hidden;"><img src="thumb.php?src=images/pro-pic.jpg&w=20&q=100" style="width:20px;" width="20" /></div></td>
                  <?php } ?>
                  <td width="57%" style="color:#ffffff;"><a href="viewmemberplay.php?refID=<?=$memberid[$x_value]?>&T=R"><?php echo $row_photo['username'];?></a></td>
    ...
    <!--  <table width="100%" border="0" cellspacing="0" bgcolor="#252525">
        ...
        <tr>
          <td colspan="2" class="style54"><div class="style57" style="height:30px; padding:5px; border:solid 1px #999999;">
            <table width="100%" border="0">
              <tr>
                <td width="13%"><div style="width:20px; height:20px; border:solid 1px #999999;"><img src="thumb.php?src=images/pro-pic.jpg&w=20&q=100" width="20" /></div></td>
	  ...
	  <br><br>
      <a href="http://banners.dfbanners.com/redirect.aspx?pid=6638&bid=3801&lpid=874" target="_blank"><img src="images/dafabet_logo.jpg" width="240" /></a><br /><br />
	  
      
      <center>
	  <a href='http://aff.512xiaojin.com/Accept.ashx?sid=df193591-98be-4a2c-92fa-99b0ca16acec&lang=th-th&aid=759&cid=c64af71a-bc4d-46e7-8ac2-acea90c5b938'><img src='images/thSBnG_120x120.gif' width="240" border='0'></a>
<br /><br />
<a href='http://aff.512xiaojin.com/Accept.ashx?sid=082c9f3a-41a8-4d30-b827-a5f7414ca6c8&lang=id-id&aid=759&cid=732c5955-ec92-4bae-93d8-9666c853d573'><img src='images/indoSbnG_230x100.gif' width="240" border='0'></a>

<br /><br />

<a href='http://aff.512xiaojin.com/Accept.ashx?sid=2aa52cfc-8562-49a5-b921-0d9a5bad3e8b&lang=th-th&aid=759&cid=3fa8cd22-34c5-43c2-94a1-e62abdc31a3d'><img src='images/thSBnG_320x100.gif' width="240" border='0'></a>
